...
import 'package:nike_admin/styles/colors_extension.dart';
import 'package:nike_admin/styles/indecator.dart';
...
class StatsState extends State {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: headingblack(subtext: "Statistics"),
        // centerTitle: true,
        elevation: 0,
